...
import clusteringRouter from "./modules/clustering/clustering.routes";
...
app.use(`${env.API_PREFIX}/clustering`, clusteringRouter);
app.use(`${env.API_PREFIX}/geo`, geoRouter);
