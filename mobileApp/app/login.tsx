          ...
          <View className="w-full max-w-md mx-auto relative z-10 p-6 bg-canvas rounded-lg shadow-card-soft border border-hairline">
            ...
            <View className="space-y-4 mb-6">
              ...
              <View className="flex-row items-center justify-between gap-x-4">
                <Text className="text-sm font-medium text-ink min-w-[65px]">
                  Email:
                </Text>
                <TextInput
                  className="flex-1 rounded-md border border-hairline bg-canvas px-4 py-3 text-ink text-sm"
